      ...
      <div class="modal-header">
        ...
        <form action="../database/function" method="POST">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="insertdata-user" class="btn btn-secondary">Save Data</button>
            </div>
        </form>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
                  <label>Address</label>
                  <textarea class="form-control" name="txt_addr" id="addr" type="text" placeholder="Enter Address" rows="3"></textarea>
  </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" name="updatedata-user" class="btn btn-secondary">Update Data</button>
            </div>
        </form>
      ...
      <div class="modal-header">
        ...
        <form action="../database/function" method="POST">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="deletedata-user" class="btn btn-secondary"> Yes !! Delete it. </button>
            </div>
        </form>
    ...
    <div class="jumbotron">
        ...
        <div class="card">
            ...
            <?php
                ...
                $query = "SELECT * from users where ut=0";
